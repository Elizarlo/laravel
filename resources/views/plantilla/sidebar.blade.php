    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li @click="menu=0" class="nav-item">
              <!--<a class="nav-link active" onclick="redirect('principal')"><i class="icon-speedometer"></i> Home</a>-->
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li @click="menu=1" class="nav-item">
                        <!--<a class="nav-link" onclick="redirect('usuarios')"><i class="icon-bag"></i> Ver Usuarios</a>-->
                        <a class="nav-link" href="#" ><i class="icon-bag"></i> Ver Usuarios</a>
                    </li>
